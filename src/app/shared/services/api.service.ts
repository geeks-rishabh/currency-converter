...
export class ApiService {
  ...
  });//this.httpClient.get(`${environment.apiURL}timeseries?start_date=${start_date}&end_date=${today}&base=${currencyFrom}&symbols=${currencyTo}`, this.headers).pipe(catchError(this.handleError));
  }
